                ...
                <table class="table table-form">
                    <tbody>
                        <tr>
                            <td>No. Reg.</td>
                            <td>:</td>
                            <td>{{ Form::text('regid',null,array('required','class'=>'input-medium','placeholder'=>'Nomor Registrasi')) }}</td>
                            <td>Nama</td>
                            <td>:</td>
                            <td>{{ Form::text('nama',null,array('required','class'=>'input-xlarge','placeholder'=>'Nama')) }}</td>
                            <td>Tanggal</td>
                            <td>:</td>
                            <td>{{ Form::text('tgl',date('d-m-Y'),array('required','class'=>'input-small datepicker','placeholder'=>'Nama')) }}</td>
                            <td>&nbsp;</td>
...
<script type="text/javascript" src="qzprint/js/3rdparty/deployJava.js"></script>
<script type="text/javascript" src="qzprint/js/qz-websocket.js"></script>
...
function getCertificate(callback) {
    ...
    $.ajax({
        method: 'GET',
        url: 'qzprint/assets/auth/public-key.txt',
        async: false,
...
function printEPL() {
    ...
    // Hint:  Carriage Return = \r, New Line = \n, Escape Double Quotes= \"
    qz.append('Eries Hermanto\n');
    qz.print();
//    qz.appendImage(path + 'qzprint/assets/img/image_sample_bw.png', 'EPL', 150, 300);
...
function printZPL() {
    ...
    qz.appendImage(getPath() + 'qzprint/assets/img/image_sample_bw.png', 'ZPLII');
...
function printHTML() {
    ...
    // HTML image
    var colB = '<img src="' + getPath() + 'qzprint/assets/img/image_sample.png">';
